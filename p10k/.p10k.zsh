# Generated by Powerlevel10k configuration wizard on 2024-04-10 at 16:31 -04.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰿈󰿈'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='𝞉t/𝞉r'
  # Custom prefix.
